  ...
  <div>
    ...
    <section class="flex min-h-screen items-center pt-20">
      <div class="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <h1 class="hero-animate max-w-4xl text-4xl font-extralight leading-tight tracking-tight text-white md:text-6xl lg:text-7xl">
          Escalamos os
    ...
    <section id="contato" class="py-24">
      <div class="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div class="scroll-reveal grid grid-cols-1 gap-4 md:grid-cols-3">
          <!-- WhatsApp -->
          <a
            href="https://wa.me/5500000000000?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20Escala%20Digital."
            target="_blank"
          ...
          >
            ...
            <div class="relative">
              ...
              <p class="mt-3 text-sm font-light text-[#25D366] transition-colors group-hover:text-[#25D366]">(00) 00000-0000</p>
            </div>
          </a>
